 ...
 * Ela herda todos os métodos de CRUD (Criar, Ler, Atualizar e Deletar) do
 * Spring Data JPA.
 */
// @Repository// Indica ao Spring que esta classe é um componente de acesso a
// dados (Repository) e permite a tradução de exceções do banco.
