...
// List<Ninja>  == Devolve vários Ninjas (pode haver mais de um com parte do nome igual).
...
// Ninja ninjaAtualizado == Objeto com os novos dados que vão substituir os antigos.
