...
public class NinjaController {
     ...
     * o Spring cria e injeta automaticamente — isso se chama IoC (Inversão de
     * Controle).
     */
    @Autowired
    ...
    @GetMapping // Mapeia requisições HTTP GET para este método.
                // GET = "me dá uma informação" — usado para BUSCAR dados, nunca para criar ou
                // editar.
    ...
    // Optional<Ninja> == pode retornar um Ninja ou vazio — não estoura erro se não
    // achar.
    @GetMapping("/id/{id}")
